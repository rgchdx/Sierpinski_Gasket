...
window.onload = function init()
{
    ...
    for (var i = 0; positions.length < numPositions; ++i) { //same algorithm as Richie_Dix_gasket1.js
...
function render()
{
    gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT); //Added the DEPTH_BUFFER_BIT flag
